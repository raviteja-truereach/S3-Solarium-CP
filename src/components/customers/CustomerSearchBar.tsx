...
import { updateSearchTerm } from '../../store/slices/customerSlice';
import { selectSearchTerm } from '../../store/selectors/customerSelectors';
    ...
    <View style={styles.container} testID={testID}>
      <View style={styles.searchBar}>
        ...
        <TextInput
          ...
          accessibilityHint="Type to filter customers by name, phone, or address"
        />
